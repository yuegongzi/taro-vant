        ...
        >
          <Cascader
            ...
            onFinish={({ selectedOptions }) => {
              set({
                v1: false,
                t1: selectedOptions.map((option) => option.text).join('/'),
              })
            }}
          />
        </Popup>
        ...
        >
          <Cascader
            ...
            onFinish={({ selectedOptions }) => {
              set({
                v2: false,
                t2: selectedOptions.map((option) => option.text).join('/'),
              })
            }}
          />
        </Popup>
        ...
        >
          <Cascader
            ...
            onFinish={({ selectedOptions }) => {
              set({
                v4: false,
                t4: selectedOptions.map((option) => option.text).join('/'),
              })
            }}
          />
        </Popup>
        ...
        >
          <Cascader
            ...
            onFinish={({ selectedOptions }) => {
              set({
                v3: false,
                t3: selectedOptions.map((option) => option.name).join('/'),
              })
            }}
          />
        </Popup>
