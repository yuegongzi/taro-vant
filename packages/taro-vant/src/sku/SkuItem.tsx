...
const SkuItem: FC<SkuItemProps> = (props) => {
  ...
  return (<View
    ...
    >
      {
        skuValue.imgUrl &&
        <View className={classNames(bem('item-img'))}>
          <Image src={skuValue.imgUrl} fit='cover'/>
        </View>
      }
